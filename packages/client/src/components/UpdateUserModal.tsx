...
import {
  ...
  export default function UpdateUserModal() {
    ...
    const handleOnSubmit = async (e: { preventDefault: () => void; }) => {
      ...
      await axios.put(`${baseURL}/user/update`, payload, {
    ...
    return (
      <> 
        <Button onClick={onOpen} alignSelf='end' size='xs' ><EditIcon w={6} h={6} /></Button>
        ...
        <Modal isOpen={isOpen} onClose={onClose}>
          ...
          <ModalContent color="white" bgGradient="linear(to-bl, #447761, #000)">
            <ModalHeader fontSize="30px" textAlign="center" mb="0">
              Update user info
              <Text fontSize='md' mt={4}>Fill in what you want to update and leave the other inputs blank.</Text>
            </ModalHeader>
            <ModalCloseButton />
            <ModalBody pb={6}>
              <FormControl mt={2}>
